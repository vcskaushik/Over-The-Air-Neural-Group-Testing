...
- **Verification (audit follow-up, §6 of the doc):** confirmed the decision and corrected three overreaches. Key: the pretrained adversary **under-converges at 30 ep for both arms** (+3.5–5.4 pp at 60 ep). At **converged (60-ep), matched-FPR** utility, HSIC λ=30 (**22.14%**) and noise −7 dB (**21.77%**, recall 0.993) are a **dead tie** — not "HSIC wins." No recall-preserving window survives; the E3 combination "complementarity" was a 30-ep artifact. Verdict unchanged, firmer.
