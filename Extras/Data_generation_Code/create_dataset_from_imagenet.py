...
IMAGE_NET_PATH = 'ImageNet-ILSVRC2012'
GROUP_TESTING_DATASET_PATH = 'GroupTestingDataset'
...
task_list = [ firearm_list,[ f for f in folder_list if f not in ban_list and f not in firearm_list ]]
